...
class StatefulTwinCubitWrapper<TCubit1 extends Cubit<TState1>, TState1,
    TCubit2 extends Cubit<TState2>, TState2> extends StatelessWidget {
  ...
  const StatefulTwinCubitWrapper({
    Key? key,
